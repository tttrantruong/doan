                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class=" form">
                                    <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{route('admin.suaNhaCungCapP')}}">
                                        {{ csrf_field() }}
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                @enderror
                                                <input class=" form-control" id="cname" value="{{$nhaCungCap->TenNhaCungCap}}" name="TenNhaCungCap" minlength="2" type="text" required />
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <input class="form-control " id="cemail" value="{{$nhaCungCap->SDTNhaCungCap}}" type="text" name="SDTNhaCungCap" required />
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="curl" class="control-label col-lg-2">Mail</label>
                                            <div class="col-lg-10">
                                                @error('MailNhaCungCap')
                                                <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <input class="form-control " id="curl" value="{{$nhaCungCap->MailNhaCungCap}}" type="email" name="MailNhaCungCap" />
                                            </div>
                                        </div>
                                        <input type="text" value="{{$nhaCungCap->IDNhaCungCap}}" name="id" hidden>

                                        <div class="form-group ">
                                            <label for="ccomment" class="control-label col-lg-2">Địa Chỉ</label>
                                            <div class="panel-body col-md-10">
                                                @error('DiaChiNhaCungCap')
                                                <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <textarea class="summernote" name="DiaChiNhaCungCap" id="" cols="30" rows="10">{{$nhaCungCap->DiaChiNhaCungCap}}</textarea>
