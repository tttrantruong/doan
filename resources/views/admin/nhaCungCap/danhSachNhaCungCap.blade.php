...
@if(!empty(session()->get("messThemNhaCungCap")))
<script>
    alert("Thêm Nhà Cung Cấp Thành Công !!!");
</script>
@php
session()->forget('messThemNhaCungCap');
@endphp
@endif
@if(!empty(session()->get("messXoaNhaCungCap")))
<script>
    alert("Xóa Nhà Cung Cấp Thành Công !!!");
</script>
@php
session()->forget('messXoaNhaCungCap');
@endphp
@endif

@if(!empty(session()->get("messCapNhatNhaCungCap")))
<script>
    alert("Cập Nhât Nhà Cung Cấp Thành Công !!!");
</script>
@php
session()->forget('messCapNhatNhaCungCap');
@endphp
@endif
<body>
                        ...
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <span class="tools pull-right">
                                    <a href="{{route('admin.themNhaCungCap')}}" class="btn btn-info" style="color: white;">Thêm Nhà Cung Cấp</a>
                                </span>
                                <br> <br>
                            </header>
                                    ...
                                    <table class="display table table-bordered table-striped" id="dynamic-table">
                                        ...
                                        @foreach($nhaCungCaps as $nhaCungCap)
                                            <tr class="gradeX">
                                                ...
                                                <td>{{$nhaCungCap->SDTNhaCungCap}}</td>
                                                <td>{{$nhaCungCap->MailNhaCungCap}}</td>
                                                <td>{{$nhaCungCap->DiaChiNhaCungCap}}</td>
                                                <td class="center hidden-phone">
                                                    <a href="{{url('/admin/sua-nha-cung-cap/')}}/{{$nhaCungCap->IDNhaCungCap}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                                    <a href="{{url('/admin/xoa-nha-cung-cap/')}}/{{$nhaCungCap->IDNhaCungCap}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a>
                                                </td>
                                            </tr>
@endforeach
                                        </tbody>
