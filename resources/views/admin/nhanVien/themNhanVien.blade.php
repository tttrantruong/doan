                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class=" form">
                                    <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{route('admin.themNhanVienP')}}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                @enderror
                                                <input class=" form-control" id="cname" name="TenNhanVien" minlength="2" type="text" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <input class="form-control " id="cemail" type="text" name="SDTNhanVien" required />
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <input class="form-control " id="curl" type="text" name="MailNhanVien" />
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <input class="form-control " id="curl" type="text" name="Password" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="panel-body col-md-10">
                                                ...
                                                <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <textarea class="summernote" name="DiaChiNhanVien" id="" cols="30" rows="10"></textarea>
