                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td class="center hidden-phone">
                                                    <a title="Cập Nhật" href="{{url('/admin/sua-nhan-vien/')}}/{{$nhanVien->IDNhanVien}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                                    <a title="Xóa" href="{{url('/admin/xoa-nhan-vien/')}}/{{$nhanVien->IDNhanVien}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
