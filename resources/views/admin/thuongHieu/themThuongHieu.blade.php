                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class=" form">
                                    <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{route('admin.themThuongHieuP')}}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                @enderror
                                                <input class=" form-control" id="cname" name="TenThuongHieu" minlength="2" type="text" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="panel-body col-md-10">
                                                ...
                                                <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <textarea class="summernote" name="MoTaThuongHieu" id="" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
