                        ...
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <span class="tools pull-right">
                                    <a href="{{route('admin.themSanPham')}}" class="btn btn-info" style="color: white;">Thêm Sản Phẩm</a>
                                </span>
                            </header>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td class="center hidden-phone">
                                                    <a href="{{url('/admin/sua-san-pham/')}}/{{$sanPham->IDSanPham}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                                    <a href="{{url('/admin/xoa-san-pham/')}}/{{$sanPham->IDSanPham}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
