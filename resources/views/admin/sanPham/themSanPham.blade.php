                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class=" form">
                                    <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{route('admin.themSanPhamP')}}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <input class="form-control " id="cemail" type="number" name="GiaBan" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="panel-body col-md-10">
                                                ...
                                                <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <textarea class="summernote" name="MoTa" name="" id="" cols="30" rows="10"></textarea>
