                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" style="margin-bottom: 200px;">
                                <div class=" form">
                                    <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{route('admin.suaBaiVietP')}}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                @enderror
                                                <input class=" form-control" value="{{$baiViet->TieuDe}}" id="cname" name="TieuDe" minlength="2" type="text" required />
                                            </div>
                                        </div>
                                        <div class="form-group last">
                                            ...
                                            <div class="col-md-10">
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <img style="width: 150px; height: 150px;" src="{{url($baiViet->ImgBaiViet)}}" alt="">
                                        ...
                                        <input type="text" name="id" value="{{$baiViet->IDBaiViet}}" hidden id="">
                                        <input type="text" name="ImgBaiViet2" value="{{$baiViet->ImgBaiViet}}" hidden id="">
                                        <div class="form-group ">
                                            ...
                                            <div class="panel-body col-md-10">
                                                ...
                                                <small class="form-text text-danger">{{$message}}</small>
                                                @enderror
                                                <textarea class="summernote" name="NoiDung" id="" cols="30" rows="10">{{$baiViet->NoiDung}}</textarea>
