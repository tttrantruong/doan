                  ...
                  <div class="col-sm-6">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" role="form" action="{{route('admin.thongKeSanPhamP')}}" method="post" enctype="multipart/form-data">
                              {{ csrf_field() }}
                  ...
                  <div class="col-sm-6">
                      <section class="panel">
                          ...
                          <table class="table table-striped">
                              ...
                              <tr>
                                  <td>{{$i++}}</td>
                                  <td>{{SanPham::where('IDSanPham',$d->SanPhamID)->first()->TenSanPham}}</td>
                                  <td><img style="width: 50px; height: 50px;" src="{{url(SanPham::where('IDSanPham',$d->SanPhamID)->first()->ImgSanPham)}}" alt=""></td>
                                  <td>{{$d->sl}}</td>
                                  <td>{{$ngaybt}}</td>
                                  <td>{{$ngaykt}}</td>
                              </tr>
